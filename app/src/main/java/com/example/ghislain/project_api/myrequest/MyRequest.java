package com.example.ghislain.project_api.myrequest;
...
public class MyRequest {
    ...
    public void register(final String pseudo, final String email, final String password, final String password2, final RegisterCallback callback){
        ...
        String url = "http://192.168.1.13/Project_API/register.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error){
                        ...
                        if (messages.has("pseudos")){
                            errors.put("pseudos", messages.getString("pseudos"));
                        }
    ...
    public void connection(final String pseudo, final String password, final LoginCallback callback){
        ...
        String url = "http://192.168.1.13/Project_API/login.php";
